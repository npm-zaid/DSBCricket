...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    // Entrance Animation: Staggered pop-in with a slight bounce
    gsap.fromTo(buttons, 
      ...
      { 
        ...
        stagger: 0.15, 
        ease: "back.out(1.7)",
        scrollTrigger: ctaRef.current // Assumes ScrollTrigger is registered
      }
    );
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center px-6 pt-32 pb-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#dda15e] font-semibold">Every ball has a winner.</span>
        </p>
    ...
    >
      {/* Primary Action: The Cricketer Scout Button */}
          ...
          {[
            ...
            return (
              ...
              <div
                ...
                className="group relative rounded-2xl border border-white/10  bg-zinc-900/80 p-7 backdrop-blur transition hover:-translate-y-3 hover:shadow-[0_30px_80px_rgba(221,161,94,0.25)]"
              >
